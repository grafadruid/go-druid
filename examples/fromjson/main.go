...
func main() {
	...
	q, err = d.Query().Load([]byte("{\"bound\":\"minTime\",\"context\":{},\"dataSource\":{\"name\":\"wikipedia\",\"type\":\"table\"},\"intervals\":{\"type\":\"intervals\",\"intervals\":[\"1980-06-12T22:30:00.000Z/2020-01-26T23:00:00.000Z\"]},\"queryType\":\"timeBoundary\"}"))
	spew.Dump(q, err)
	d.Query().Execute(q, &results)
	spew.Dump(results)
	...
	q, err = d.Query().Load([]byte("{\"analysisTypes\":[\"minmax\",\"interval\",\"size\",\"cardinality\",\"timestampSpec\",\"queryGranularity\",\"aggregators\",\"rollup\"],\"context\":{\"\":\"\"},\"dataSource\":{\"name\":\"wikipedia\",\"type\":\"table\"},\"intervals\":{\"type\":\"intervals\",\"intervals\":[\"1980-06-12T22:30:00.000Z/2020-01-26T23:00:00.000Z\"]},\"queryType\":\"segmentMetadata\"}"))
	spew.Dump(q, err)
	d.Query().Execute(q, &results)
	spew.Dump(results)
}
